...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/csp-gateway-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/csp-gateway-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add csp-gateway csp-gateway-client
# for installing globally
pixi global install csp-gateway csp-gateway-client
```
...
It is possible to list all of the versions of `csp-gateway` available on your platform:
...
```
pixi search csp-gateway --channel conda-forge
```
